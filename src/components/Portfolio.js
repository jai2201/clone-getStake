  ...
  return (
    <div className="transition-all duration-500 bg-[#F7FAFC] min-h-screen min-w-[81%] p-8 font-display dark:bg-black">
      ...
      <div className="mt-10">
        ...
        <div className="flex">
          <div className="transition-all duration-200 w-1/3 bg-white rounded-xl p-4 mt-4 mr-4 dark:bg-slate-800 cursor-pointer hover:scale-110">
          ...
          <div className="transition-all duration-200 w-1/3 bg-white rounded-xl p-4 mt-4 mx-4 dark:bg-slate-800 cursor-pointer hover:scale-110">
            <p className="flex justify-between">
              <span className="text-slate-700 dark:text-slate-600">
                Property ID
              </span>
          ...
          <div className="transition-all duration-200 w-1/3 bg-white rounded-xl p-4 mt-4 ml-4 dark:bg-slate-800 cursor-pointer hover:scale-110">
            <p className="flex justify-between">
              <span className="text-slate-700 dark:text-slate-600">
                Property ID
              </span>
